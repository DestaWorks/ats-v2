...
} from "@destaworks/integrations/ai/briefs/daily-brief";
import {
  generateWeeklyBrief,
  type WeeklyBriefContext,
} from "@destaworks/integrations/ai/briefs/weekly-brief";
import {
  generateWeeklyPatterns,
  type WeeklyPatternsWeek,
} from "@destaworks/integrations/ai/briefs/weekly-patterns";
import { suggestTargets as aiSuggestTargets } from "@destaworks/integrations/ai/briefs/targets-suggest";
import {
  briefRepository,
  type DailyBriefRow,
  type WeeklyBriefRow,
} from "@destaworks/db/repositories/brief.repository";
import { dailyRepository } from "@destaworks/db/repositories/daily.repository";
