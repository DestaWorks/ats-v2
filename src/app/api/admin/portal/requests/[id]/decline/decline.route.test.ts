...
/** POST /api/admin/portal/requests/:id/decline — gated `configureClientPortal`. */
...
vi.mock("@/server/services/portal-access-request.service", () => ({
  portalAccessRequestService: { decline: h.decline },
}));
...
const postReq = () =>
  new Request("http://localhost/api/admin/portal/requests/r1/decline", { method: "POST" });
...
describe("POST /api/admin/portal/requests/:id/decline", () => {
