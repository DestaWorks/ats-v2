...
export function SignInForm({ googleEnabled }: { googleEnabled: boolean }) {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- reads the error param once and clears it; including router would re-run after the replace it just performed.
  }, [searchParams]);
