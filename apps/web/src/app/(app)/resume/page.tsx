 ...
 * down as props (mirrors `SignInForm googleEnabled`). Reading `@destaworks/integrations/ai/config` and
 * `@destaworks/integrations/storage` here is allowed: `src/app` may import server modules; the
 * client flow may NOT.
 */
