...
import {
  ...
  findTemplate,
  clientTemplateInfo,
} from "@destaworks/domain/constants/templates";
import { OUTREACH_CHANNELS, type OutreachChannel } from "@destaworks/domain/constants/lead-status";
import { fillTemplate, type TemplateFillContext } from "@destaworks/domain/rules/fill-template";
import {
        ...
        {TEMPLATE_CATEGORIES.map((cat) => {
          ...
          return (
            <button
              ...
              type="button"
              onClick={() => {
                const first = templatesByCategory(cat.id)[0];
