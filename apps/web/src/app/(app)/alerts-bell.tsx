...
function AlertsPanel({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- run once per open; onRefresh is recreated each parent render and listing it would refetch on every one.
  }, []);
    ...
    <div className="flex max-h-[80vh] flex-col">
      ...
      <div className="overflow-y-auto py-1.5">
        ...
        <SectionHeader className="text-charcoal">
          @Mentions
          {alerts && alerts.unread > 0 ? ` · ${alerts.unread} new` : ""}
        </SectionHeader>
        {mentions.length === 0 ? (
