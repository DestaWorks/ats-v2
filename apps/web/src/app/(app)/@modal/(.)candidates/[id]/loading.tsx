...
export default function InterceptedDetailLoading() {
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/40 p-4 sm:p-8">
      ...
      >
        {/* `animate-pulse` scoped to just the bars, NOT the panel above — Tailwind's pulse
            animates opacity, and putting it on the dialog itself (which also carries `bg-white`)
            faded the WHOLE panel in and out, letting the page underneath show through. */}
