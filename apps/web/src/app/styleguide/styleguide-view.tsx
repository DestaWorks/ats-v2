 ...
 * stack, and accessible dnd-kit drag-and-drop. The client half; `page.tsx` is the server guard.
 */
...
import { Input, controlClass } from "@destaworks/ui/input";
...
import { ScoreBadge } from "@destaworks/ui/score-badge";
...
import { signInSchema, type SignInInput } from "@destaworks/contracts/validation/auth";
